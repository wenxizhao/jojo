...
def setpos(runComponent):
	...
	global pos_go
	global pos_home
	getpos(pos_home,'id/menu_home_page',runComponent)
	getpos(pos_title,'id/title_bg',runComponent)
	...
	device.type('a')
	getpos(pos_go,'id/go',runComponent)
	#close keyboard
...
def pageload(company):
	...
	device.shell('am force-stop com.dolphin.browser.xf')
